...
cd common
./comp-common-no-rdbms-diags.sh
echo "Common modules done"
cd ../general
./comp-gl-no-rdbms-diags.sh
echo "General Ledger done"
cd ../irs
./comp-irs-no-rdbms-diags.sh
echo "IRS done"
cd ../purchase
./comp-purchase-no-rdbms-diags.sh
echo "Purchase Ledger done"
cd ../sales
./comp-sales-no-rdbms-diags.sh
echo "Sales Ledger done"
cd ../stock
./comp-stock-no-rdbms-diags.sh
...
#echo "Epos done"
#
echo "Compiled for No RDBMS with diags"
