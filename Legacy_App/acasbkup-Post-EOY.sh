...
# 09/02/2018 vbc - Version for back up after running irs060 or XL150
#                  There is another for pre-EOY (irs060 or XL150).
#                  For IRS it is coded within the irs program near call to irs065.
#
...
#cd temp-backups
tar cvfz `pwd`"/temp-backups/acas-bkup-"`date +%Y%m%d%H%M%S-Post-EOY`.tar.gz *.dat**
#
