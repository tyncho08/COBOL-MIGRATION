...
--
-- Updated DB ,config 30/03/2024 --  20:00:03
--
...
--
-- Table structure for table `DELIVERY-REC`
--

DROP TABLE IF EXISTS `DELIVERY-REC`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `DELIVERY-REC` (
...
--
-- Dumping data for table `DELIVERY-REC`
--

LOCK TABLES `DELIVERY-REC` WRITE;
/*!40000 ALTER TABLE `DELIVERY-REC` DISABLE KEYS */;
/*!40000 ALTER TABLE `DELIVERY-REC` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Defaults table for IRS';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `PUAUTOGEN-LINES-REC`
--

DROP TABLE IF EXISTS `PUAUTOGEN-LINES-REC`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PUAUTOGEN-LINES-REC` (
...
--
-- Dumping data for table `PUAUTOGEN-LINES-REC`
--

LOCK TABLES `PUAUTOGEN-LINES-REC` WRITE;
/*!40000 ALTER TABLE `PUAUTOGEN-LINES-REC` DISABLE KEYS */;
/*!40000 ALTER TABLE `PUAUTOGEN-LINES-REC` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `PUAUTOGEN-REC`
--

DROP TABLE IF EXISTS `PUAUTOGEN-REC`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PUAUTOGEN-REC` (
  ...
  `IH-FREQ` char(1) NOT NULL,
  `IH-REPEAT` decimal(2,0) NOT NULL,
  `IH-LAST-DATE` int(8) unsigned NOT NULL,
...
--
-- Dumping data for table `PUAUTOGEN-REC`
--

LOCK TABLES `PUAUTOGEN-REC` WRITE;
/*!40000 ALTER TABLE `PUAUTOGEN-REC` DISABLE KEYS */;
/*!40000 ALTER TABLE `PUAUTOGEN-REC` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `SAAUTOGEN-LINES-REC`
--

DROP TABLE IF EXISTS `SAAUTOGEN-LINES-REC`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `SAAUTOGEN-LINES-REC` (
  `IL-LINE-KEY` char(10) NOT NULL,
  `IL-INVOICE` int(8) unsigned NOT NULL,
  `IL-LINE` tinyint(2) unsigned NOT NULL,
  `IL-PRODUCT` char(13) NOT NULL,
...
--
-- Dumping data for table `SAAUTOGEN-LINES-REC`
--

LOCK TABLES `SAAUTOGEN-LINES-REC` WRITE;
/*!40000 ALTER TABLE `SAAUTOGEN-LINES-REC` DISABLE KEYS */;
/*!40000 ALTER TABLE `SAAUTOGEN-LINES-REC` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `SAAUTOGEN-REC`
--

DROP TABLE IF EXISTS `SAAUTOGEN-REC`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `SAAUTOGEN-REC` (
...
--
-- Dumping data for table `SAAUTOGEN-REC`
--

LOCK TABLES `SAAUTOGEN-REC` WRITE;
/*!40000 ALTER TABLE `SAAUTOGEN-REC` DISABLE KEYS */;
/*!40000 ALTER TABLE `SAAUTOGEN-REC` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `SALEDGER-REC` (
  ...
  `SALES-STATS-DATE` char(4) NOT NULL,
  `SALES-PARTIAL-SHIP-FLAG` char(1) NOT NULL,
...
CREATE TABLE `STOCK-REC` (
  ...
  `STOCK-CONSTRUCT-BUNDLE` int(6) unsigned NOT NULL,
  `STOCK-UNDER-CONSTRUCTION` int(6) unsigned NOT NULL,
  `STOCK-WORK-IN-PROGRESS` int(6) unsigned NOT NULL,
  `STOCK-REORDER-PNT` int(6) unsigned NOT NULL,
  `STOCK-STD-REORDER` int(6) unsigned NOT NULL,
  `STOCK-BACK-ORDERED` int(6) unsigned NOT NULL,
  `STOCK-ON-ORDER` int(6) unsigned NOT NULL,
  `STOCK-HELD` int(6) unsigned NOT NULL,
  `STOCK-PRE-SALES` int(6) unsigned NOT NULL,
  ...
  `STOCK-ARRIVAL-DATE` int(8) unsigned NOT NULL,
  ...
  KEY `STCKRCAltNdx03` (`STOCK-LOCATION`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SYSTEM-REC` (
  ...
  `COMPANY-EMAIL` char(30) NOT NULL,
  ...
  `STATS-DATE-PERIOD` char(4) NOT NULL,
  `P-C` char(1) NOT NULL,
  ...
  `GL-BL-PAY-AC` int(8) unsigned NOT NULL,
  `GL-P-CREDITORS` int(8) unsigned NOT NULL,
  `GL-BL-PURCH-AC` int(8) unsigned NOT NULL,
  `GL-SL-PAY-AC` int(8) unsigned NOT NULL,
  `GL-S-DEBTORS` int(8) unsigned NOT NULL,
  `GL-SL-SALES-AC` int(8) unsigned NOT NULL,
  ...
  `PL-AUTOGEN` char(1) NOT NULL,
  `PL-NEXT-REC` smallint(4) unsigned NOT NULL,
  ...
  `SL-INVOICE-LINES` tinyint(2) unsigned NOT NULL,
  `SL-AUTOGEN` char(1) NOT NULL,
  `SL-NEXT-REC` smallint(4) NOT NULL,
  ...
  `SL-BO-FLAG` char(1) NOT NULL,
  `STK-BO-ACTIVE` char(1) NOT NULL,
...
-- Dump completed on 2024-03-30  20:00:03
