...
# 09/02/2018 vbc - Version for back up prior to running irs060 or XL150 [Pre-EOY]
#                  There is another for post-EOY
...
#cd temp-backups
tar cvfz `pwd`"/temp-backups/acas-bkup-"`date +%Y%m%d%H%M%S-Pre-EOY`.tar.gz *.dat**
#
