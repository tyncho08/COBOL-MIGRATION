...
*> 20/03/18 vbc Reversed order of sub keys so we could sort by stock #
*>              and changed levels down by two i.e., 05 -> 03, 07 => 05.
*>
 01  WS-Stock-Audit-Record.
     ...
     03  Audit-Process-Date        pic x(10).      *> Locale date format
