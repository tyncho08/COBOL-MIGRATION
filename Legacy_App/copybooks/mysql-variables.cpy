...
*> This version can be used for presql2 programs, taken     *
*>                from ACAS but the procedures needs to be  *
*>                changed as not compatable.                *
*>                                                          *
*>***********************************************************
*>                                                          *
...
*>    NOT YET IN USE AS TESTING IS NEEDED TO SEE IF REQUIRED IN BUSY
*>      INSTALLATIONS WHERE Data conflicts can occur may be?
*>
*>  THIS IS NOT NEEDED FOR PRESQL Compiler tools.
*>
