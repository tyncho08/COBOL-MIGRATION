...
*>                                                          *
*>  ERROR MSG: SM901 must also be set up in calling module  *
*>             SM004 must be set up in calling module       *
*>                   within screen section display block.   *
*>                                                          *
...
*>    along with message SM901
*>
     move WS-Mysql-Error-Number    to WSd-Mysql-Error-Number.
     move WS-No-Paragraph          to WSd-No-Paragraph.
     move Ws-Mysql-Command         to Wsd-Mysql-Command.
     move Ws-Mysql-Error-Message   to Wsd-Mysql-Error-Message.

     display  Display-Message-2.  *>  with erase eos.
     display  SM901.              *>        at line ws-lines col 1.
