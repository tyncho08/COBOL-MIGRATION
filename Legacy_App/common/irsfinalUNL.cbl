...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 irsfinalUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(22)    value "irsfinalUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(38) value "SY003 Problem reading irsfinal file = ".
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Final-Record from Final-Record
