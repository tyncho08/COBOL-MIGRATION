...
*>
     open     input    Del-Inv-Nos-File-Seq.
     ...
     if       FS-Reply not = zeros
              move     spaces to SO-Print
              string   "Failed on open - DelFolio file = "
                       FS-Reply
                           into SO-Print
              perform  Call-Sysout
              move     "CLOSE " to SO-Print
...
*>
 aa010-Read-Recs.
     perform  forever
              read     Del-Inv-Nos-File-seq next record at end
              ...
              write    Del-Inv-Nos-Record from WS-Del-Inv-Nos-Record
