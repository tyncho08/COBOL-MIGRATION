...
*>**
*>   Changes.
*>  3/06/23 vbc - .00 paymentsRES source taken from analysisRES.
...
*>----------------------
 77  prog-name           pic x(22)    value "paymentsRES (3.02.00)".
...
*>
     ...
     if       FS-Reply not = zeros
              move     spaces to SO-Print
              string   "Failed on open - Payments file = "
                       FS-Reply
                           into SO-Print
              perform  Call-Sysout
              move     "CLOSE " to SO-Print
...
*>
 aa010-Read-Recs.
     perform  forever
              read     Payments-File-Seq next record at end
              ...
              write    Pay-Record from WS-Pay-Record
