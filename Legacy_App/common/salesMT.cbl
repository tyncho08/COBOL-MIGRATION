...
*>**
*> Remarks.             Sales Ledger File RDB Handler using amended JC preSQL.
*>                      **********************************************
*>
...
*>                      from the ACAS
*>                      Sales Ledger file handler acas012
...
*>**
*> Called by Modules:
*>                      acas012 - Sales Ledger Cobol Handler.
*>
*>**
*> Error Messages Used.
...
*> 02/01/17 vbc -     Taken from purchMT.
*> 15/01/17 vbc - .06 Support for fn-Read-By-Name for SL165.
*> 19/02/17 vbc - .07 Change start key to literal conteent between quote.
...
*>    ********              WS-Sales-Record = Contents of data record to be written/read
...
*>
 ...
 77  prog-name           pic x(17)    value "SalesMT (3.02.11)".
*>
...
*>
*> Metadata on primary and alternate keys...  from Prima DAL for SALEDGER-REC
*>
 01  Table-Of-Keynames.
     03  filler         pic x(30) value 'SALES-KEY                     '.
     03  filler         pic x(8)  value '00010007'. *> offset/length
...
*>
*> Special for selective read next.
*>
         05  Most-Cursor-Set-2 pic 9    value zero.
...
*> /MYSQL VAR\
*>       ACASDB
*>       TABLE=SALEDGER-REC,HV
 COPY "mysql-variables.cpy".
*>
*>    Definitions for the SALEDGER-REC Table
*>
       01  TP-SALEDGER-REC                       USAGE POINTER.
       01  TD-SALEDGER-REC.
           05  HV-SALES-KEY                      PIC X(7).
           05  HV-SALES-NAME                     PIC X(30).
           05  HV-SALES-ADDRESS                  PIC X(96).
           05  HV-SALES-PHONE                    PIC X(13).
           05  HV-SALES-EXT                      PIC X(4).
           05  HV-SALES-EMAIL                    PIC X(30).
           05  HV-SALES-FAX                      PIC X(13).
           05  HV-SALES-STATUS                   PIC  9(03) COMP.
           05  HV-SALES-LATE                     PIC  9(03) COMP.
           05  HV-SALES-DUNNING                  PIC  9(03) COMP.
           05  HV-EMAIL-INVOICE                  PIC  9(03) COMP.
           05  HV-EMAIL-STATEMENT                PIC  9(03) COMP.
           05  HV-EMAIL-LETTERS                  PIC  9(03) COMP.
           05  HV-DELIVERY-TAG                   PIC  9(03) COMP.
           05  HV-NOTES-TAG                      PIC  9(03) COMP.
           05  HV-SALES-CREDIT                   PIC  9(03) COMP.
           05  HV-SALES-DISCOUNT                 PIC  9(02)V9(02) COMP.
           05  HV-SALES-LATE-MIN                 PIC  9(05) COMP.
           05  HV-SALES-LATE-MAX                 PIC  9(05) COMP.
           05  HV-SALES-LIMIT                    PIC  9(10) COMP.
           05  HV-SALES-ACTIVETY                 PIC  9(10) COMP.
           05  HV-SALES-LAST-INV                 PIC  9(10) COMP.
           05  HV-SALES-LAST-PAY                 PIC  9(10) COMP.
           05  HV-SALES-AVERAGE                  PIC  9(10) COMP.
           05  HV-SALES-PAY-ACTIVETY             PIC  9(10) COMP.
           05  HV-SALES-PAY-AVERAGE              PIC  9(10) COMP.
           05  HV-SALES-PAY-WORST                PIC  9(10) COMP.
           05  HV-SALES-CREATE-DAT               PIC  9(10) COMP.
           05  HV-SALES-CURRENT                  PIC S9(08)V9(02) COMP.
           05  HV-SALES-LAST                     PIC S9(08)V9(02) COMP.
           05  HV-TURNOVER-Q1                    PIC S9(08)V9(02) COMP.
           05  HV-TURNOVER-Q2                    PIC S9(08)V9(02) COMP.
           05  HV-TURNOVER-Q3                    PIC S9(08)V9(02) COMP.
           05  HV-TURNOVER-Q4                    PIC S9(08)V9(02) COMP.
           05  HV-SALES-UNAPPLIED                PIC S9(08)V9(02) COMP.
           05  HV-SALES-STATS-DATE               PIC X(4).
           05  HV-SALES-PARTIAL-SHIP-FLAG        PIC X(1).
*> /MYSQL-END\
...
*>                    TABLE=SALEDGER-REC
           ...
           STRING "SELECT * FROM "
             "`SALEDGER-REC`"
             " WHERE "
             ws-Where (1:J)      *> Sales-KEY > "0000000" ORDER BY SALEDGER-REC ASC
...
*>
     ...
     move     HV-Sales-Key to WS-File-Key.
...
*>
     ...
     string   "`"                   delimited by size
              ...
              "`"                   delimited by size
              '="'                  delimited by size
              WS-Sales-Record (K:L)       delimited by size
              '"'                   delimited by size
                      into WS-Where
                        with pointer J
     end-string
...
*>
     ...
     move     WS-Where (1:J)  to WS-Log-Where.    *>  For test logging
     move     WS-Sales-Record (K:L) to WS-File-Key
     if    Testing-2
           display Display-Message-1 with erase eos
     end-if
*>
...
*>
 ba070-Process-Write.
     perform  bb000-HV-Load.                       *>  move WS-Sales-Record fields to HV fields
...
*>                    TABLE=SALEDGER-REC
           ...
           STRING "SELECT * FROM "
             "`SALEDGER-REC`"
             " WHERE "
             ws-Where (1:J)      *> Sales-KEY > "0000000" ORDER BY SALES-NAME ASC
            ";"  X"00" INTO WS-MYSQL-COMMAND
           PERFORM MYSQL-1210-COMMAND THRU MYSQL-1219-EXIT
           PERFORM MYSQL-1220-STORE-RESULT THRU MYSQL-1239-EXIT
           MOVE WS-MYSQL-RESULT TO TP-SALEDGER-REC
...
*>
     initialize TD-SALEDGER-REC.
     move     WS-Sales-Key       to HV-SALES-KEY
     move     Sales-NAME         to HV-SALES-NAME
     move     Sales-ADDRESS      to HV-SALES-ADDRESS
     move     Sales-PHONE        to HV-SALES-PHONE
     move     Sales-EXT          to HV-SALES-EXT
     move     Sales-EMAIL        to HV-SALES-EMAIL
     move     Sales-FAX          to HV-SALES-FAX
     move     Sales-STATUS       to HV-SALES-STATUS
     move     Sales-Late         to HV-SALES-LATE
     move     Sales-Dunning      to HV-SALES-DUNNING
     move     Email-Invoice      to HV-EMAIL-INVOICE
     move     Email-Statement    to HV-EMAIL-STATEMENT
     move     Email-Letters      to HV-EMAIL-LETTERS
     move     Delivery-Tag       to HV-DELIVERY-TAG
     move     Notes-Tag          to HV-NOTES-TAG
     move     Sales-CREDIT       to HV-SALES-CREDIT
     move     Sales-DISCOUNT     to HV-SALES-DISCOUNT
     move     Sales-Late-MIN     to HV-SALES-Late-MIN
     move     Sales-Late-Max     to HV-SALES-Late-MAX
     move     Sales-LIMIT        to HV-SALES-LIMIT
     move     Sales-ACTIVETY     to HV-SALES-ACTIVETY
     move     Sales-LAST-INV     to HV-SALES-LAST-INV
     move     Sales-LAST-PAY     to HV-SALES-LAST-PAY
     move     Sales-AVERAGE      to HV-SALES-AVERAGE
     move     Sales-PAY-ACTIVETY to HV-SALES-PAY-ACTIVETY
     move     Sales-PAY-AVERAGE  to HV-SALES-PAY-AVERAGE
     move     Sales-PAY-WORST    to HV-SALES-PAY-WORST
     move     Sales-CREATE-DATE  to HV-SALES-CREATE-DAT
     move     Sales-CURRENT      to HV-SALES-CURRENT
     move     Sales-LAST         to HV-SALES-LAST
     move     TURNOVER-Q1        to HV-TURNOVER-Q1
     move     TURNOVER-Q2        to HV-TURNOVER-Q2
     move     TURNOVER-Q3        to HV-TURNOVER-Q3
     move     TURNOVER-Q4        to HV-TURNOVER-Q4
     move     Sales-UNAPPLIED    to HV-SALES-UNAPPLIED.
*>
...
*>
     move     HV-SALES-KEY          to  WS-Sales-Key
     move     HV-SALES-NAME         to  Sales-NAME
     move     HV-SALES-ADDRESS      to  Sales-ADDRESS
     move     HV-SALES-PHONE        to  Sales-PHONE
     move     HV-SALES-EXT          to  Sales-EXT
     move     HV-SALES-EMAIL        to  Sales-EMAIL
     move     HV-SALES-FAX          to  Sales-FAX
     move     HV-SALES-STATUS       to  Sales-STATUS
     move     HV-SALES-LATE         to  Sales-LATE
     move     HV-SALES-DUNNING      to  Sales-DUNNING
     move     HV-EMAIL-INVOICE      to  Email-INVOICE
     move     HV-EMAIL-STATEMENT    to  Email-STATEMENT
     move     HV-EMAIL-LETTERS      to  Email-LETTERS
     move     HV-DELIVERY-TAG       to  Delivery-TAG
     move     HV-NOTES-TAG          to  Notes-TAG
     move     HV-SALES-CREDIT       to  Sales-CREDIT
     move     HV-SALES-DISCOUNT     to  Sales-DISCOUNT
     move     HV-SALES-LATE-MIN     to  Sales-Late-Min
     move     HV-SALES-LATE-MAX     to  Sales-Late-Max
     move     HV-SALES-LIMIT        to  Sales-LIMIT
     move     HV-SALES-ACTIVETY     to  Sales-ACTIVETY
     move     HV-SALES-LAST-INV     to  Sales-LAST-INV
     move     HV-SALES-LAST-PAY     to  Sales-LAST-PAY
     move     HV-SALES-AVERAGE      to  Sales-AVERAGE
     move     HV-SALES-PAY-ACTIVETY to  Sales-PAY-ACTIVETY
     move     HV-SALES-PAY-AVERAGE  to  Sales-PAY-AVERAGE
     move     HV-SALES-PAY-WORST    to  Sales-PAY-WORST
     move     HV-SALES-CREATE-DAT   to  Sales-CREATE-DATE
     move     HV-SALES-CURRENT      to  Sales-CURRENT
     move     HV-SALES-LAST         to  Sales-LAST
     move     HV-TURNOVER-Q1        to  TURNOVER-Q1
     move     HV-TURNOVER-Q2        to  TURNOVER-Q2
     move     HV-TURNOVER-Q3        to  TURNOVER-Q3
     move     HV-TURNOVER-Q4        to  TURNOVER-Q4
     move     HV-SALES-UNAPPLIED    to  Sales-UNAPPLIED.
*>
 bb100-Exit.
     exit section.
*>
...
*>
           STRING '`SALES-KEY`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-NAME`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-SALES-NAME,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-ADDRESS`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-PHONE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-SALES-PHONE,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-EXT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-SALES-EXT,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-EMAIL`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-SALES-EMAIL,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-FAX`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-SALES-FAX,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-STATUS`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-STATUS
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-LATE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-LATE
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-DUNNING`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-DUNNING
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`EMAIL-INVOICE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-EMAIL-INVOICE
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`EMAIL-STATEMENT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-EMAIL-STATEMENT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`EMAIL-LETTERS`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-EMAIL-LETTERS
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`DELIVERY-TAG`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-DELIVERY-TAG
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`NOTES-TAG`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-NOTES-TAG
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-CREDIT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-CREDIT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-DISCOUNT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-DISCOUNT
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-LATE-MIN`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-LATE-MIN
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-LATE-MAX`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-LATE-MAX
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(16:05))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-LIMIT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-LIMIT
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-ACTIVETY`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-ACTIVETY
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-LAST-INV`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-LAST-INV
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-LAST-PAY`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-LAST-PAY
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-AVERAGE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-AVERAGE
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-PAY-ACTIVETY`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-PAY-ACTIVETY
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-PAY-AVERAGE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-PAY-AVERAGE
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-PAY-WORST`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-PAY-WORST
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-CREATE-DAT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-CREATE-DAT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-CURRENT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-CURRENT
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-LAST`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-LAST
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`TURNOVER-Q1`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-TURNOVER-Q1
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`TURNOVER-Q2`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-TURNOVER-Q2
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`TURNOVER-Q3`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-TURNOVER-Q3
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`TURNOVER-Q4`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-TURNOVER-Q4
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-UNAPPLIED`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-SALES-UNAPPLIED
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-STATS-DATE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-SALES-STATS-DATE,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`SALES-PARTIAL-SHIP-FLAG`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-SALES-PARTIAL-SHIP-FLAG,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ";" INTO WS-MYSQL-COMMAND
