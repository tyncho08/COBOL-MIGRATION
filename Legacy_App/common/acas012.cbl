...
*>**
*> Remarks.             Sales Ledger File Handler.
*>                      ******************
...
*>
*>        This module acas012 (along with salesMT) are the first FH (cobol File Handler for I/O)
...
*>                      SL905 Program Error: Temp rec =yyy < Sales-Rec = zzz
*>**
...
*> 26/06/20 vbc - .08 On Open change move file name to start of para.
...
*>    acas012 ONLY             WS-Sales-Record = Contents of data record to be written/read
...
*>**********************
*>
 77  prog-name           pic x(17)    value "acas012 (3.02.10)".
*>
*>
