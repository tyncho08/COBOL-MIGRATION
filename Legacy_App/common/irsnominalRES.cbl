...
*>**
*>   Changes.
*>  3/06/23 vbc - .00 irsnominalRES source taken from analysisRES.
...
*>
 fd  nominal-ledger.
 copy "irsfdwsnl.cob" replacing Record-1 by Nominal-Record.
 fd  irsnominal-File-Seq.
 copy "irswsnl.cob" replacing NL-Record by WS-Nominal-Record.
*>
 working-storage section.
*>----------------------
 77  prog-name           pic x(23)    value "irsnominalRES (3.02.00)".
...
*>
     open     input    irsNominal-file-Seq.
     ...
     if       FS-Reply not = zeros
              move     spaces to SO-Print
              string   "Failed on open - IRS Nominal file = "
                       FS-Reply
                           into SO-Print
              perform  Call-Sysout
              move     "CLOSE " to SO-Print
...
*>
 aa010-Read-Recs.
     perform  forever
              read     irsNominal-file-Seq next record at end
              ...
              write    Nominal-Record from WS-Nominal-Record
