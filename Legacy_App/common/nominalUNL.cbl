...
*>   Written.            31 May 2023.
*>**
*>   Remarks.            This module only uses the nominal    file.
*>
...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 nominalUNL source taken from analysisUNL.
...
*>
 copy "seledger.cob".
     select  ledger-File-Seq  assign          "ledger.seq"
...
*>----------------------
 77  prog-name           pic x(22)    value "nominalUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(36) value "SY003 Problem reading ledger file = ".
...
*>
     ...
     if       FS-Reply not = zeros
              move     "No ledger file to process" to SO-Print
              perform  Call-Sysout
              close    ledger-File
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-ledger-Record from ledger-Record
