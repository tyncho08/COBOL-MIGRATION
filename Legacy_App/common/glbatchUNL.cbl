...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 glbatchUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(20)    value "glbatchUNL (3.02.00)".
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Batch-Record from Batch-Record
