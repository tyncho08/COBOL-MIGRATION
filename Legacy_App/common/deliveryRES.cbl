...
*>----------------------
 77  prog-name           pic x(22)    value "deliveryRES (3.02.00)".
...
*>
     ...
     if       FS-Reply not = zeros
              move     spaces to SO-Print
              string   "Failed on open - Delivery file = "
                       FS-Reply
                           into SO-Print
              perform  Call-Sysout
              move     "CLOSE " to SO-Print
...
*>
 aa010-Read-Recs.
     perform  forever
              read     Delivery-File-Seq next record at end
              ...
              write    Delivery-Record from WS-Delivery-Record
