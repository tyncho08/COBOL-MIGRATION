...
*>   Written.            31 May 2023.
*>**
*>   Remarks.            This module only uses the otm5    file.
*>
...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 otm5UNL source taken from analysisUNL.
...
*> ****************
*>
*> This notice superxedes all prior copyright notices & was updated 2024-04-16.
*>
...
*>
 copy "plseloi5.cob".
     select  otm5-File-Seq  assign          "openitm5.seq"
...
*>-----------
*>
 copy "plfdoi5.cob" replacing Open-Item-Record-5 by OTM5-Record.
 fd  otm5-File-Seq.
 copy "plwsoi.cob".
...
*>----------------------
 77  prog-name           pic x(22)    value "otm5UNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(37) value "SY003 Problem reading otm5 file = ".
...
*>
     ...
     if       FS-Reply not = zeros
              move     "No otm5 file to process" to SO-Print
              perform  Call-Sysout
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-otm5-Record from otm5-Record
...
aa020-Finish-Off.
     ...
     goback.
*>
 copy "Proc-Get-Env-Set-Files.cob".  *> Only uses ACAS_otm5S now
*>
 Call-Sysout.
