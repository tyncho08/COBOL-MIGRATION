...
*>   Written.            3 June 2023.
*>**
*>   Remarks.            This module only uses the irsfinal    file.
*>
...
*>**
*>   Changes.
*>  3/06/23 vbc - .00 irsfinalRES source taken from analysisRES.
...
*>
     select Final-File       assign file-37
                             ...
                             status fs-reply.
*>
     select  irsfinal-File-Seq  assign        "irsfinal.seq"
...
*>
 fd  Final-File.
*>
 01  Final-Record            pic x(655).
 fd  irsfinal-File-Seq.
 copy "irswsfinal.cob" replacing Final-Record by WS-Final-Record.
*>
 working-storage section.
*>----------------------
 77  prog-name           pic x(22)    value "irsfinalRES (3.02.00)".
...
*>
 aa000-Main-Start.
     ...
     move     14     to WS-Log-File-no.  *> for FHlogger
*>
...
*>
     open     input    irsFinal-File-seq.
     if       FS-Reply not = zeros
              move     "No irsdefault file to process" to SO-Print
              perform  Call-Sysout
              close    Final-File
     ...
     if       FS-Reply not = zeros
              move     spaces to SO-Print
              string   "Failed on open - IRS Final file = "
                       FS-Reply
                           into SO-Print
              perform  Call-Sysout
              move     "CLOSE " to SO-Print
...
*>
 aa010-Read-Recs.
     perform  forever
              read     irsFinal-File-seq next record at end
              ...
              write    Final-Record from WS-Final-Record
...
aa020-Finish-Off.
     ...
     goback.
*>
 copy "Proc-Get-Env-Set-Files.cob".  *> Only uses ACAS_irsfinalS now
*>
 Call-Sysout.
