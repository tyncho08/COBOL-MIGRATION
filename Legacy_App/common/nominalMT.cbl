...
*>
*>    Definitions for the GLLEDGER-REC Table
*>
       01  TP-GLLEDGER-REC                       USAGE POINTER.
       01  TD-GLLEDGER-REC.
           05  HV-LEDGER-KEY                     PIC  9(10) COMP.
           05  HV-LEDGER-TYPE                    PIC  9(03) COMP.
           05  HV-LEDGER-PLACE                   PIC X(1).
           05  HV-LEDGER-LEVEL                   PIC  9(03) COMP.
           05  HV-LEDGER-NAME                    PIC X(32).
           05  HV-LEDGER-BALANCE                 PIC S9(08)V9(02) COMP.
           05  HV-LEDGER-LAST                    PIC S9(08)V9(02) COMP.
           05  HV-LEDGER-Q1                      PIC S9(08)V9(02) COMP.
           05  HV-LEDGER-Q2                      PIC S9(08)V9(02) COMP.
           05  HV-LEDGER-Q3                      PIC S9(08)V9(02) COMP.
           05  HV-LEDGER-Q4                      PIC S9(08)V9(02) COMP.
*> /MYSQL-END\
*>
 Linkage Section.
*>**************
...
*>                    TABLE=GLLEDGER-REC
           ...
           STRING "SELECT * FROM "
             "`GLLEDGER-REC`"
             " WHERE "
             ws-Where (1:J)      *> KEY-1 > "00000000" ORDER BY GLLEDGER-REC ASC
           ...
           MOVE WS-MYSQL-RESULT TO TP-GLLEDGER-REC
*>               /MYSQL-END\
...
*>
*>             TABLE=GLLEDGER-REC
           MOVE TP-GLLEDGER-REC TO WS-MYSQL-RESULT
...
*>
           STRING '`LEDGER-KEY`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-LEDGER-KEY
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`LEDGER-TYPE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-LEDGER-TYPE
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`LEDGER-PLACE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-LEDGER-PLACE,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`LEDGER-LEVEL`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-LEDGER-LEVEL
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
...
*>
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`LEDGER-BALANCE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-LEDGER-BALANCE
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`LEDGER-LAST`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-LEDGER-LAST
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`LEDGER-Q1`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-LEDGER-Q1
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`LEDGER-Q2`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-LEDGER-Q2
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`LEDGER-Q3`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-LEDGER-Q3
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`LEDGER-Q4`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-LEDGER-Q4
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(13:08))
