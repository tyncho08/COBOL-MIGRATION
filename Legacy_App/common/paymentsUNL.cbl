...
*>   Written.            31 May 2023.
*>**
*>   Remarks.            This module only uses the payments    file.
*>
...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 paymentsUNL source taken from analysisUNL.
...
*>
 copy "selpay.cob".
     select  payments-File-Seq  assign          "pay.seq"
...
*>
 copy "fdpay.cob".
 fd  payments-File-Seq.
 copy "plwspay.cob" replacing Pay-Record by WS-Pay-Record.
*>
 working-storage section.
*>----------------------
 77  prog-name           pic x(22)    value "paymentsUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(38) value "SY003 Problem reading payments file = ".
...
*>
 aa000-Main-Start.
     ...
     move     16     to WS-Log-File-no.  *> for FHlogger
*>
...
*>
     ...
     if       FS-Reply not = zeros
              move     "No payments file to process" to SO-Print
              perform  Call-Sysout
              close    Pay-File
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Pay-Record from Pay-Record
...
aa020-Finish-Off.
     ...
     goback.
*>
 copy "Proc-Get-Env-Set-Files.cob".  *> Only uses ACAS_paymentsS now
*>
 Call-Sysout.
