...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 plautogenUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(22)    value "plautogenUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(39) value "SY003 Problem reading plautogen file = ".
...
*>
     ...
     open     output   plautogen-File-Seq.
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-PInvoice-Record from Agen-Invoice-Record
