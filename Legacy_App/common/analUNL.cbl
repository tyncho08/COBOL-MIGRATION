...
*>**
*>   Changes.
*> 31/05/23 vbc - .00 analysisUNL Source taken from systemUNL and vers reset.
...
*>----------------------
 77  prog-name           pic x(20)    value "analUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(38) value "SY003 Problem reading Analysis file = ".
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Analysis-Record from Analysis-Record
