...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 irspostingUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(23)    value "irspostingUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(40) value "SY003 Problem reading irsposting file = ".
...
*>
     ...
     open     output   irsposting-File-Seq.
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Posting-Record from Posting-Record
