...
*>**
*> Remarks.             Sales Open-Item-File-3 File RDB Handler using amended JC preSQL.
*>                      **********************************************
*>
...
*>                      from the ACAS
*>                      Sales Invoice file handler acas019
...
*>**
*> Called by Modules:
*>                      acas019 - Sales Open-Item-File-3 Cobol Handler.
*>
*>**
*> Error Messages Used.
...
*> 08/02/17 vbc -     Taken from slinvoiceMT for OTM3 removing RG proc.
...
*>    ********              WS-OTM3-Record = Contents of data record to be written/read
...
*>
 ...
 77  prog-name           pic x(19)    value "otm3MT (3.02.11)".
*>
...
*>
 01  WS-Temp-ED-Key.
     03  WS-Temp-Ed-Customer pic x(7).
...
*>
*> Metadata on primary keys...   for SAITM3-REC
*>
 01  Table-Of-KeyNames.
     03  filler         pic x(30) value 'OI3-KEY                       '.
...
*>
*>    Definitions for the SAITM3-REC Table
*>
       01  TP-SAITM3-REC                         USAGE POINTER.
       01  TD-SAITM3-REC.
           05  HV-OI3-KEY                        PIC X(15).
           05  HV-OI3-CUSTOMER                   PIC X(7).
           05  HV-OI3-INVOICE                    PIC  9(10) COMP.
           05  HV-OI3-DAT                        PIC  9(10) COMP.
           05  HV-OI3-BATCH                      PIC X(8).
           05  HV-OI3-BATCH-NOS                  PIC X(5).
           05  HV-OI3-BATCH-ITEM                 PIC X(3).
           05  HV-OI3-TYPE                       PIC X(1).
           05  HV-OI3-DESCRIPTION                PIC X(32).
           05  HV-OI3-HOLD-FLAG                  PIC X(1).
           05  HV-OI3-UNAPL                      PIC X(1).
           05  HV-OI3-P-C                        PIC S9(07)V9(02) COMP.
           05  HV-OI3-NET                        PIC S9(07)V9(02) COMP.
           05  HV-OI3-EXTRA                      PIC S9(07)V9(02) COMP.
           05  HV-OI3-CARRIAGE                   PIC S9(07)V9(02) COMP.
           05  HV-OI3-VAT                        PIC S9(07)V9(02) COMP.
           05  HV-OI3-DISCOUNT                   PIC S9(07)V9(02) COMP.
           05  HV-OI3-E-VAT                      PIC S9(07)V9(02) COMP.
           05  HV-OI3-C-VAT                      PIC S9(07)V9(02) COMP.
           05  HV-OI3-PAID                       PIC S9(07)V9(02) COMP.
           05  HV-OI3-STATUS                     PIC X(1).
           05  HV-OI3-DEDUCT-DAYS                PIC  9(03) COMP.
           05  HV-OI3-DEDUCT-AMT                 PIC S9(03)V9(02) COMP.
           05  HV-OI3-DEDUCT-VAT                 PIC S9(03)V9(02) COMP.
           05  HV-OI3-DAYS                       PIC  9(03) COMP.
           05  HV-OI3-CR                         PIC S9(10) COMP.
           05  HV-OI3-APPLIED                    PIC X(1).
           05  HV-OI3-DATE-CLEARED               PIC  9(10) COMP.
*> /MYSQL-END\
*>
 Linkage Section.
*>**************
...
*> *> /MYSQL-END\
*>
     move    "OPEN SL OTM3" to WS-File-Key
...
*>
     ...
     move    "CLOSE SL OTM3" to WS-File-Key.
*>  /MYSQL CLOSE\
*>
*>    Close the Database
*>
...
*>                    TABLE=SAITM3-REC
           ...
           MOVE WS-MYSQL-RESULT TO TP-SAITM3-REC
*>               /MYSQL-END\
...
*>
*>             TABLE=SAITM3-REC
           MOVE TP-SAITM3-REC TO WS-MYSQL-RESULT
...
*>
     if       WS-MYSQL-Count-Rows = zero   *> no data but should not happen here
              ...
              if    WS-MYSQL-Error-Number  not = "0  "
                    ...
                    initialize WS-OTM3-Record with filler
...
*>
     ...
     move     HV-OI3-KEY to WS-File-Key.
...
*>
     ...
     string   "`"                   delimited by size
              ...
              "`"                   delimited by size
              '="'                  delimited by size
              WS-OTM3-Record (K:L)       delimited by size
              '"'                   delimited by size
                      into WS-Where
                        with pointer J
     end-string
...
*>
     ...
     move     WS-Where (1:J)  to WS-Log-Where.    *>  For test logging
     move     WS-OTM3-Record (K:L) to WS-File-Key
     if    Testing-2
           display Display-Message-1 with erase eos
     end-if
*>
...
*>
 ba070-Process-Write.             *> dry test... - Has rg01 requirements.
     perform  bb000-HV-Load.                       *>  move WS-OTM3-Record fields to HV fields
...
*>
              ...
              string   " ORDER BY "          delimited by size
                       "'OI3-INVOICE', 'OI3-DAT' ASC, "
                                             delimited by size
                       "'OI3-TYPE' DESC, "   delimited by size
...
*>
              ...
              move     1   to J
              string   " ORDER BY "          delimited by size
                       "'OI3-CUSTOMER', 'OI3-DAT', " delimited by size
...
*>
     initialize TD-SAITM3-REC.
*>
     move     OI-Invoice  to HV-OI3-INVOICE
                             WS-Temp-Ed-Invoice.
     move     OI-Customer to HV-OI3-CUSTOMER
                             WS-Temp-Ed-Customer.
     move     WS-Temp-Ed-Key  to HV-OI3-KEY
*>
     move     OI-B-Nos        to HV-OI3-BATCH-NOS
                                 WS-Temp-ED-Batch-Nos.
     move     OI-B-Item       to HV-OI3-BATCH-ITEM
                                 WS-Temp-ED-Batch-Item.
     move     WS-Temp-ED-Batch9 to HV-OI3-BATCH.
*>
     move     OI-Date         to HV-OI3-DAT
     move     OI-Type         to HV-OI3-TYPE
     move     OI-Description  to HV-OI3-DESCRIPTION
     move     OI-Hold-Flag    to HV-OI3-HOLD-FLAG
     move     OI-Unapl        to HV-OI3-UNAPL
     move     OI-P-C          to HV-OI3-P-C
     move     OI-Net          to HV-OI3-NET
     move     OI-Extra        to HV-OI3-EXTRA
     move     OI-Carriage     to HV-OI3-CARRIAGE
     move     OI-Vat          to HV-OI3-VAT
     move     OI-Discount     to HV-OI3-DISCOUNT
     move     OI-E-Vat        to HV-OI3-E-VAT
     move     OI-C-Vat        to HV-OI3-C-VAT
     move     OI-Paid         to HV-OI3-PAID
     move     OI-Status       to HV-OI3-STATUS
     move     OI-Deduct-Days  to HV-OI3-DEDUCT-DAYS
     move     OI-Deduct-Amt   to HV-OI3-DEDUCT-AMT
     move     OI-Deduct-Vat   to HV-OI3-DEDUCT-VAT
     move     OI-Days         to HV-OI3-DAYS
     move     OI-CR           to HV-OI3-CR
     move     OI-Applied      to HV-OI3-APPLIED
     move     OI-Date-Cleared to HV-OI3-DATE-CLEARED.
*>
 bb000-Exit.
     exit section.
*>
...
*>
     initialize WS-OTM3-Record.
*>
     move     HV-OI3-INVOICE       to OI-Invoice
     move     HV-OI3-CUSTOMER      to OI-Customer
     move     HV-OI3-DAT           to OI-Date
*>
     move     HV-OI3-BATCH-NOS     to OI-B-Nos
     move     HV-OI3-BATCH-ITEM    to OI-B-Item
*>
     move     HV-OI3-TYPE          to OI-Type
     move     HV-OI3-DESCRIPTION   to OI-Description
     move     HV-OI3-HOLD-FLAG     to OI-Hold-Flag
     move     HV-OI3-UNAPL         to OI-Unapl
     move     HV-OI3-P-C           to OI-P-C
     move     HV-OI3-NET           to OI-Net
     move     HV-OI3-EXTRA         to OI-Extra
     move     HV-OI3-CARRIAGE      to OI-Carriage
     move     HV-OI3-VAT           to OI-Vat
     move     HV-OI3-DISCOUNT      to OI-Discount
     move     HV-OI3-E-VAT         to OI-E-Vat
     move     HV-OI3-C-VAT         to OI-C-Vat
     move     HV-OI3-PAID          to OI-Paid
     move     HV-OI3-STATUS        to OI-Status
     move     HV-OI3-DEDUCT-DAYS   to OI-Deduct-Days
     move     HV-OI3-DEDUCT-AMT    to OI-Deduct-Amt
     move     HV-OI3-DEDUCT-VAT    to OI-Deduct-Vat
     move     HV-OI3-DAYS          to OI-Days
     move     HV-OI3-CR            to OI-CR
     move     HV-OI3-APPLIED       to OI-Applied
     move     HV-OI3-DATE-CLEARED  to OI-Date-Cleared.
*>
 bb100-Exit.
     exit section.
*>
...
*>
           STRING '`OI3-KEY`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-KEY,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-CUSTOMER`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-CUSTOMER,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-INVOICE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-INVOICE
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-DAT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-DAT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-BATCH`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-BATCH,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-BATCH-NOS`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-BATCH-NOS,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-BATCH-ITEM`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-BATCH-ITEM,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-TYPE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-TYPE,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-DESCRIPTION`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-DESCRIPTION,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-HOLD-FLAG`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-HOLD-FLAG,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-UNAPL`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-UNAPL,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-P-C`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-P-C
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-NET`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-NET
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(14:07))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-EXTRA`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-EXTRA
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(14:07))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-CARRIAGE`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-CARRIAGE
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(14:07))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-VAT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-VAT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(14:07))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-DISCOUNT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-DISCOUNT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(14:07))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-E-VAT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-E-VAT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(14:07))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-C-VAT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-C-VAT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(14:07))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-PAID`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-PAID
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(14:07))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-STATUS`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-STATUS,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-DEDUCT-DAYS`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-DEDUCT-DAYS
             TO WS-MYSQL-EDIT
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-DEDUCT-AMT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-DEDUCT-AMT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-DEDUCT-VAT`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-DEDUCT-VAT
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-DAYS`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-DAYS
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(18:03))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-CR`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-CR
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
           ...
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-APPLIED`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING FUNCTION TRIM (HV-OI3-APPLIED,TRAILING)
                  '"'
                   INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           STRING ', 'INTO WS-MYSQL-COMMAND
           WITH POINTER WS-MYSQL-I end-string
*>
           STRING '`OI3-DATE-CLEARED`="' INTO WS-MYSQL-COMMAND
                   WITH POINTER WS-MYSQL-I end-string
           MOVE HV-OI3-DATE-CLEARED
             TO WS-MYSQL-EDIT
           STRING FUNCTION TRIM (WS-MYSQL-EDIT(11:10))
             INTO WS-MYSQL-COMMAND
             WITH POINTER WS-MYSQL-I end-string
