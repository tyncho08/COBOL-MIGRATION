...
*>**
*>   Changes.
*>  3/06/23 vbc - .00 otm5RES source taken from analysisRES.
...
*>----------------------
 77  prog-name           pic x(22)    value "otm5RES (3.02.00)".
...
*>
     ...
     if       FS-Reply not = zeros
              move     spaces to SO-Print
              string   "Failed on open OTM5 file = "
                       FS-Reply
                           into SO-Print
              perform  Call-Sysout
              move     "CLOSE " to SO-Print
...
*>
 aa010-Read-Recs.
     perform  forever
              read     otm5-File-Seq next record at end
              ...
              write    otm5-Record from WS-otm5-Record
