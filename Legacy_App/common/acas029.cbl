...
*>
*>        This module came from acas019 Invoice).
*>
...
*> 07/01/18 vbc -     Taken from acas019 DAL & DAL named as otm5MT.
...
*>    acas029 ONLY             WS-OTM5-Record = Contents of data record to be written/read
