...
*>**
*> Remarks.             PL Autogen File Handler.
*>                      Taken from PL Invoice File Handler.
*>                      **********************************
...
*>                      acas030 created from acas026 May 2023.
*>
*>
*> Changes.
*> 02/05/23 vbc - .12 Set for acas030 from acas026 and version reset to .00 with change log cleared.
...
*>**********************
*>
 77  prog-name          pic x(17)  value "acas030 (3.02.00)".
*>
...
*>
     ...
     move     17     to WS-Log-File-No.  *> RDB, File/Table
*>
...
*> 27/07/16 16:30     move     zeros to FS-Reply WE-Error.
     ...
     move     "OPEN PL AUTOGEN File" to WS-File-Key.
     if       fs-reply not = zero
...
*> 27/07/16 16:30     move     zeros to FS-Reply WE-Error.
     move     zero to Cobol-File-Status.
     move     "CLOSE PL AUTOGEN File" to WS-File-Key
...
*>
     ...
     if       FS-Reply not = zero
              go to aa999-main-exit.
     move     Agen-Invoice-Record to WS-PInvoice-Record.
     perform  aa041-Move-Inv-Data.
     move     zeros to WE-Error.
     go to    aa999-main-exit.
*>
  aa041-Move-Inv-Data.   *> Not really needed as both fields are now chars but my RE-typing :)
...
*>
 aa070-Process-Write.
     ...
     move     WS-PInvoice-Record to Agen-Invoice-Record.
...
*>
     call     "plautogenMT" using File-Access
                                  ACAS-DAL-Common-data
