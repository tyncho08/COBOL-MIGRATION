...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 valueUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(24)    value "valueUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(41) value "SY003 Problem reading value file = ".
...
*>
     ...
     if       FS-Reply not = zeros
              move     "No value file to process" to SO-Print
              perform  Call-Sysout
              close    Value-File
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Value-Record from Value-Record
