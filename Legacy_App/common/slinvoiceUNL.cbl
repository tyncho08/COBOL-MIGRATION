...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 invoiceUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(24)    value "invoiceUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(41) value "SY003 Problem reading Invoice file = ".
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Invoice-Record from Invoice-Record
