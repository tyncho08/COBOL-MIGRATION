...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 pInvoiceUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(22)    value "pInvoiceUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(39) value "SY003 Problem reading pInvoice file = ".
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-PInvoice-Record from Invoice-Record
