...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 PurchaseUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(22)    value "purchUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(39) value "SY003 Problem reading Purchase file = ".
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Purch-Record from Purch-Record
