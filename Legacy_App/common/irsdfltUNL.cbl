...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 irsdfltUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(22)    value "irsdfltUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(37) value "SY003 Problem reading irsdflt file = ".
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Default-Record from Default-Record
