...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 SalesUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(22)    value "salesUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(39) value "SY003 Problem reading Sales file = ".
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Sales-Record from Sales-Record
