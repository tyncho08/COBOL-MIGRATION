...
*>   Written.            3 June 2023.
*>**
*>   Remarks.            This module only uses the plautogen    file.
*>
...
*>**
*>   Changes.
*>  3/06/23 vbc - .00 plautogenRES source taken from analysisRES.
...
*>-----------
*>
 copy "plSELautogen.cob".
     select  plautogen-File-Seq  assign       "plautogen.seq"
...
*>-----------
*>
 copy "plFDautogen.cob".
 fd  plautogen-File-Seq.
 copy "plwspinv.cob" replacing PInvoice-Header by WS-PInvoice-Record.
*>
 working-storage section.
*>----------------------
 77  prog-name           pic x(22)    value "plautogenRES (3.02.00)".
...
*>
 aa000-Main-Start.
     ...
     move     4      to WS-Log-System.   *> 1 = IRS, 2=GL, 3=SL, 4=PL, 5=Stock used in FH logging, 6=SL & PL
...
*>
     open     input    plautogen-File-Seq.
     if       FS-Reply not = zeros
              move     "No plautogen file to process" to SO-Print
              perform  Call-Sysout
     ...
     open     output   Agen-Invoice-File.
     if       FS-Reply not = zeros
              move     spaces to SO-Print
              string   "Failed on open plautogen file = "
                       FS-Reply
                           into SO-Print
              perform  Call-Sysout
              move     "CLOSE " to SO-Print
...
*>
 aa010-Read-Recs.
     perform  forever
              read     plautogen-File-Seq next record at end
              ...
              write    Agen-Invoice-Record from WS-PInvoice-Record
...
aa020-Finish-Off.
     ...
     goback.
*>
 copy "Proc-Get-Env-Set-Files.cob".  *> Only uses ACAS_plautogenS now
*>
 Call-Sysout.
