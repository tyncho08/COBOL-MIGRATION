...
*>**
*> Remarks.             Sales Invoice File RDB Handler using amended JC preSQL.
*>                      **********************************************
*>
...
*>                      The primary (SAINVOICE-REC) has all columns that directly link
*>                      to the Cobol file Header data and
*>                      SAINV-LINES-REC for up to 40 rows for those both using the
