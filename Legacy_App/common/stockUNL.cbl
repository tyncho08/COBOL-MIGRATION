...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 stockUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(24)    value "stockUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(41) value "SY003 Problem reading stock file = ".
...
*>
     ...
     if       FS-Reply not = zeros
              move     "No stock file to process" to SO-Print
              perform  Call-Sysout
              close    Stock-File
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Stock-Record from Stock-Record
