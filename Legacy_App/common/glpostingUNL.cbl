...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 postingUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(22)    value "glpostingUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(37) value "SY003 Problem reading posting file = ".
