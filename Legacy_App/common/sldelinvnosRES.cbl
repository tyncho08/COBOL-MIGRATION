...
*>**
*>   Changes.
*>  3/06/23 vbc - .00 sldelinvnosRES source taken from analysisRES.
...
*>----------------------
 77  prog-name           pic x(24)    value "sldelinvnosRES (3.02.00)".
...
*>
     ...
     if       FS-Reply not = zeros
              move     spaces to SO-Print
              string   "Failed on open sldelinvnos file = "
                       FS-Reply
                           into SO-Print
              perform  Call-Sysout
              move     "CLOSE " to SO-Print
