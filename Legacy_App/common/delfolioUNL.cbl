...
*>   Written.            31 May 2023.
*>**
*>   Remarks.            This module only uses the delfolio    file.
*>
...
*>**
*>   Changes.
*> 1/06/23 vbc - .00 delfolioUNL source taken from analysisUNL.
...
*>
 copy "selpdnos.cob".
     select  Del-Inv-Nos-File-Seq  assign     "delfolio.seq"
...
*>
 copy "fddnos.cob".
 fd  Del-Inv-Nos-File-Seq.
 copy "wsdnos.cob".
*>
 working-storage section.
*>----------------------
 77  prog-name           pic x(24)    value "delfolioUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(41) value "SY003 Problem reading delfolio file = ".
...
*>
     ...
     if       FS-Reply not = zeros
              move     "No delfolio file to process" to SO-Print
              perform  Call-Sysout
     ...
     open     output   Del-Inv-Nos-File-Seq.
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Del-Inv-Nos-Record from Del-Inv-Nos-Record
...
aa020-Finish-Off.
     ...
     goback.
*>
 copy "Proc-Get-Env-Set-Files.cob".  *> Only uses ACAS_delfolioS now
*>
 Call-Sysout.
