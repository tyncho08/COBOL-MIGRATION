...
*>   Written.            31 May 2023.
*>**
*>   Remarks.            This module only uses the sldelinvnos    file.
*>
...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 sldelinvnosUNL source taken from analysisUNL.
...
*>
 copy "seldnos.cob".
     select  Del-Inv-Nos-File-Seq  assign          "delinvnos.seq"
...
*>----------------------
 77  prog-name           pic x(24)    value "sldelinvnosUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(41) value "SY003 Problem reading sldelinvnos file = ".
...
*>
     ...
     if       FS-Reply not = zeros
              move     "No sldelinvnos file to process" to SO-Print
              perform  Call-Sysout
...
aa020-Finish-Off.
     ...
     goback.
*>
 copy "Proc-Get-Env-Set-Files.cob".  *> Only uses ACAS_sldelinvnosS now
*>
 Call-Sysout.
