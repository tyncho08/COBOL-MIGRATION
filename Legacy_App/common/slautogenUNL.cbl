...
*>**
*>   Changes.
*>  1/06/23 vbc - .00 slautogenUNL source taken from analysisUNL.
...
*>----------------------
 77  prog-name           pic x(22)    value "slautogenUNL (3.02.00)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(39) value "SY003 Problem reading slautogen file = ".
...
*>
     ...
     open     output   Agen-Invoice-File-Seq.
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-Invoice-Record from Agen-Invoice-Record
