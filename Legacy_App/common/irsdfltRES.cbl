...
*>   Written.            3 June 2023.
*>**
*>   Remarks.            This module only uses the irsdflt    file.
*>
...
*>**
*>   Changes.
*>  3/06/23 vbc - .00 irsdfltRES source taken from analysisRES.
...
*>
     select Default-File     assign file-35
                             ...
                             status fs-reply.
*>
     select  irsdflt-File-Seq  assign        "irsdflt.seq"
...
*>
 fd  Default-File.
*>
 01  Default-Record            pic x(264).
 fd  irsdflt-File-Seq.
 copy "irswsdflt.cob" replacing Default-Record by WS-Default-Record.
*>
 working-storage section.
*>----------------------
 77  prog-name           pic x(22)    value "irsdfltRES (3.02.00)".
...
*>
     ...
     if       FS-Reply not = zeros
              move     spaces to SO-Print
              string   "Failed on open - IRS Default file = "
                       FS-Reply
                           into SO-Print
              perform  Call-Sysout
              move     "CLOSE " to SO-Print
...
*>
 aa010-Read-Recs.
     perform  forever
              read     irsdflt-File-Seq next record at end
              ...
              write    Default-Record from WS-Default-Record
...
aa020-Finish-Off.
     ...
     goback.
*>
 copy "Proc-Get-Env-Set-Files.cob".  *> Only uses ACAS_irsdfltS now
*>
 Call-Sysout.
